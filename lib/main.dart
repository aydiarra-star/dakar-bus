...
final List<Stop> demoStops = [
  ...
  const Stop(name: 'Arrêt DDD Ligne 12', direction: 'Dir. Ouakam', schedule: '6 min', price: '300 FCFA', distance: '800 m', icon: Icons.directions_bus_filled_rounded, color: AppColors.ddd, location: LatLng(14.7250, -17.4900)),
];
...
class _HomePageState extends State<HomePage> {
  ...
  void _locateUser() {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Position centrée sur Colobane'),
            ...
            Expanded(
              child: ListView(
                ...
                children: [
                  ...
                  const Text('Prochains départs autour de vous', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                  const SizedBox(height: 12),
