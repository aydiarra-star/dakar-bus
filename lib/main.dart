...
class OppositeStopService {
  static Stop? findOppositeStop({
    ...
    // 1. Recherche géographique et sémantique par proximité (< 50 mètres)
    Stop? bestCandidate;
    ...
    for (final stop in allStops) {
      ...
      // Rayon de 50 mètres max pour trouver l'arrêt d'en face
...
// ============================================================
// NOUVELLE VUE : DOUBLE SENS (ALLER / RETOUR) STYLE IDFM
// ============================================================
class DualStopDetailPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Détection automatique de l'arrêt opposé (Sens B) dans toute la liste des arrêts
