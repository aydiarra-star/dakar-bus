          ...
          child: Row(
            children: [
              Container(
                  ...
                  child:
                      Icon(stop.icon, color: Colors.white, size: 20)),
              const SizedBox(width: 10),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const SizedBox(height: 20),
            _section('Général'),
            _toggle('Notifications', 'Alertes de passage',
                Icons.notifications_outlined, _notifications,
                (v) => setState(() => _notifications = v)),
            _toggle('Localisation GPS', 'Position en temps réel',
                Icons.location_on_outlined, _gps,
                (v) => setState(() => _gps = v)),
            const SizedBox(height: 20),
            _section('Réseaux'),
            _tileSetting('TER', 'Train Express Régional',
                Icons.train_rounded, AppColors.ter),
            _tileSetting('BRT', 'Bus Rapid Transit',
                Icons.directions_bus_rounded, AppColors.brt),
            _tileSetting('AFTU', 'Lignes de bus',
                Icons.directions_bus_outlined, AppColors.aftu),
            _tileSetting('Tata', 'Bus Tata',
                Icons.directions_bus_filled, AppColors.tata),
            _tileSetting('DDD', 'Dakar Dem Dikk',
                Icons.directions_bus_filled_rounded, AppColors.ddd),
            const SizedBox(height: 20),
            _section('À propos'),
            Container(
              padding: const EdgeInsets.all(16),
                ...
                children: [
                  ...
                  Text('Version 1.0.0',
                      style: TextStyle(
                          ...
                          color: AppColors.textSecondary)),
                  SizedBox(height: 8),
                  Text('Tous les horaires dans ta poche',
                      style: TextStyle(
                          fontSize: 12,
                          color: AppColors.textSecondary,
      ...
      child: Row(
        children: [
          Container(
              ...
              height: 36,
              decoration:: BoxDecoration(
                  color: color Text.withOpacity(0.15),
                  borderRadius:(' BorderRadius.circular(8)),
             🔔 child: Icon(icon, color: Al color, size: 20)),
          const SizedBox(width: 12),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
...
class _AIChatPageState extends State<AIChatPage> {
  ...
  final List<Map<String, String>> _messages = [
    {
      'role': 'ai',
      'text':
          'Bonjour ! Je suis votre assistant Dakar Bus. Posez-moi une question.'
    },
  ];
  ...
  String _generateResponse(String query) {
    ...
    if (q.contains('brt'))
      return 'Prochain BRT à Colobane dans 1 min, dir. Guédiawaye Petersen. 400 FCFA.';
    if (q.contains('ter'))
      return 'Prochain TER de Dakar dans 5 min, dir. Diamniadio. 500 FCFA.';
    if (q.contains('aftu') || q.contains('23'))
      return 'AFTU Ligne 23 dans 3 min, dir. Parcelles Assainies. 200 FCFA.';
    if (q.contains('tata') || q.contains('12'))
      return 'Tata 12 dans 4 min, dir. Guédiawaye. 250 FCFA.';
    if (q.contains('ddd'))
      return 'DDD Ligne 12 dans 6 min, dir. Ouakam. 300 FCFA.';
    if (q.contains('plateau'))
      return 'Pour le Plateau : BRT depuis Colobane, ~15 min.';
