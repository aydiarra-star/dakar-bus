...
final List<Stop> terStations = [
  ...
  const Stop(name: 'Gare TER Hann', direction: 'Dir. Diamniadio', price: '500 FCFA', distance: '3.5 km', minutesUntilArrival: 6, icon: Icons.train_rounded, color: AppColors.ter, location: LatLng(14.7222, -17.4321)),
  const Stop(name: 'Gare TER Dalifort', direction: 'Dir. Diamniadio', price: '500 FCFA', distance: '5.1 km', minutesUntilArrival: 8, icon: Icons.train_rounded, color: AppColors.ter, location: LatLng(14.7410, -17.4120)),
  const Stop(name: 'Gare TER Baux Maraîchers', direction: 'Dir. Diamniadio', price: '500 FCFA', distance: '6.3 km', minutesUntilArrival: 10, icon: Icons.train_rounded, color: AppColors.ter, location: LatLng(14.7470, -17.4010)),
  const Stop(name: 'Gare TER Pikine', direction: 'Dir. Diamniadio', price: '500 FCFA', distance: '7.2 km', minutesUntilArrival: 12, icon: Icons.train_rounded, color: AppColors.ter, location: LatLng(14.7550, -17.3900)),
  const Stop(name: 'Gare TER Thiaroye', direction: 'Dir. Diamniadio', price: '500 FCFA', distance: '8.1 km', minutesUntilArrival: 14, icon: Icons.train_rounded, color: AppColors.ter, location: LatLng(14.7588, -17.3803)),
  const Stop(name: 'Gare TER Yeumbeul', direction: 'Dir. Diamniadio', price: '600 FCFA', distance: '11.5 km', minutesUntilArrival: 16, icon: Icons.train_rounded, color: AppColors.ter, location: LatLng(14.7700, -17.3400)),
  const Stop(name: 'Gare TER Keur Mbaye Fall', direction: 'Dir. Diamniadio', price: '600 FCFA', distance: '14.2 km', minutesUntilArrival: 18, icon: Icons.train_rounded, color: AppColors.ter, location: LatLng(14.7750, -17.3100)),
  const Stop(name: 'Gare TER PNR', direction: 'Dir. Diamniadio', price: '600 FCFA', distance: '16.8 km', minutesUntilArrival: 20, icon: Icons.train_rounded, color: AppColors.ter, location: LatLng(14.7500, -17.2900)),
  const Stop(name: 'Gare TER Rufisque', direction: 'Dir. Diamniadio', price: '700 FCFA', distance: '22.1 km', minutesUntilArrival: 24, icon: Icons.train_rounded, color: AppColors.ter, location: LatLng(14.7157, -17.2703)),
  const Stop(name: 'Gare TER Bargny', direction: 'Dir. Diamniadio', price: '700 FCFA', distance: '28.5 km', minutesUntilArrival: 28, icon: Icons.train_rounded, color: AppColors.ter, location: LatLng(14.6900, -17.2200)),
...
final List<Stop> otherStations = [
  ...
  const Stop(name: 'BRT Grand Dakar', direction: 'Dir. Guédiawaye', price: '400 FCFA', distance: '1.5 km', minutesUntilArrival: 3, icon: Icons.directions_bus_rounded, color: AppColors.brt, location: LatLng(14.7050, -17.4400)),
  const Stop(name: 'BRT Liberté 6', direction: 'Dir. Guédiawaye', price: '400 FCFA', distance: '3.4 km', minutesUntilArrival: 7, icon: Icons.directions_bus_rounded, color: AppColors.brt, location: LatLng(14.7220, -17.4330)),
  const Stop(name: 'BRT Sacré-Cœur', direction: 'Dir. Guédiawaye', price: '400 FCFA', distance: '4.0 km', minutesUntilArrival: 8, icon: Icons.directions_bus_rounded, color: AppColors.brt, location: LatLng(14.7280, -17.4300)),
  const Stop(name: 'BRT Parcelles', direction: 'Dir. Guédiawaye', price: '400 FCFA', distance: '5.0 km', minutesUntilArrival: 10, icon: Icons.directions_bus_rounded, color: AppColors.brt, location: LatLng(14.7350, -17.4260)),
  const Stop(name: 'BRT Grand Médine', direction: 'Dir. Guédiawaye', price: '400 FCFA', distance: '6.2 km', minutesUntilArrival: 12, icon: Icons.directions_bus_rounded, color: AppColors.brt, location: LatLng(14.7450, -17.4180)),
  const Stop(name: 'BRT Scat Urbam', direction: 'Dir. Guédiawaye', price: '400 FCFA', distance: '7.5 km', minutesUntilArrival: 14, icon: Icons.directions_bus_rounded, color: AppColors.brt, location: LatLng(14.7520, -17.4100)),
  const Stop(name: 'PEM Guédiawaye', direction: 'Terminus nord BRT', price: '400 FCFA', distance: '10.5 km', minutesUntilArrival: 20, icon: Icons.directions_bus_rounded, color: AppColors.brt, location: LatLng(14.7735, -17.3977)),
  const Stop(name: 'Arrêt AFTU 23', direction: 'Dir. Parcelles Assainies', price: '200 FCFA', distance: '280 m', minutesUntilArrival: 3, icon: Icons.directions_bus_outlined, color: AppColors.aftu, location: LatLng(14.6900, -17.4460)),
  const Stop(name: 'Arrêt AFTU 10', direction: 'Dir. Grand Yoff', price: '200 FCFA', distance: '450 m', minutesUntilArrival: 5, icon: Icons.directions_bus_outlined, color: AppColors.aftu, location: LatLng(14.7200, -17.4600)),
  ...
  const Stop(name: 'Arrêt Tata 8', direction: 'Dir. Pikine', price: '250 FCFA', distance: '900 m', minutesUntilArrival: 6, icon: Icons.directions_bus_filled, color: AppColors.tata, location: LatLng(14.7500, -17.4200)),
  const Stop(name: 'Arrêt DDD 12', direction: 'Dir. Ouakam', price: '300 FCFA', distance: '800 m', minutesUntilArrival: 6, icon: Icons.directions_bus_filled_rounded, color: AppColors.ddd, location: LatLng(14.7250, -17.4900)),
  const Stop(name: 'Arrêt DDD 7', direction: 'Dir. Plateau', price: '300 FCFA', distance: '1.2 km', minutesUntilArrival: 8, icon: Icons.directions_bus_filled_rounded, color: AppColors.ddd, location: LatLng(14.7350, -17.4500)),
];
...
class AlertsPage extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final alerts = allStops.take(5).toList();
    return Scaffold(
      backgroundColor: AppColors.background,
      body: SafeArea(
        bottom: false,
